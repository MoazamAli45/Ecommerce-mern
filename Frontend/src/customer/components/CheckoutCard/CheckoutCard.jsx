...
const CheckoutCard = (item) => {
  ...
  }, [removeButtonClick, dispatch, item?.item?._id, item.item.quantity]);
          ...
          <div className="flex flex-col  sm:flex-row gap-6 flex-wrap">
            ...
            <div className="flex gap-3 flex-col">
              ...
              <p className={classDescription}>
                Size:
                {item?.item?.size[0].toUpperCase() + item?.item?.size.slice(1)}
              </p>
              <p className={classDescription}>
                Seller :{" "}
            ...
            <div className="flex items-center gap-3 my-2">
              <RemoveCircleOutlineIcon
                ...
                onClick={() => {
                  if (item.item.quantity === 0) {
                    setRemoveButtonClick(true);
                    handleUpdateHandler(0);
                    return;
                  }
                  handleUpdateHandler(-1);
                }}
              />
